...
public class MapNodeGroup extends Group {
    ...
    public MapNodeGroup(MapNode node) {
        ...
        loadNodeAssets();
        nodeIcon = new Image(
            ServiceLocator.getResourceService() .getAsset(getNodeIcon(),
            Texture.class));
    ...
    private void loadNodeAssets() {
        String[] nodeAssets = {"images/combat_icon.png", "images/shop_icon.png"
            , "images/event_icon.png", "images/final_icon.png"};
