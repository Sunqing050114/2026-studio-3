...
public class InOutOnTrigger extends Clickable {
    ...
    private void slideUp() {
        ...
        btn.addAction(
                Actions.sequence(
                        ...
                        Actions.moveTo(targetX, overshootY, ANIMATION_DURATION * 0.8f + random.nextFloat(), Interpolation.pow2Out),
                        Actions.moveTo(targetX, targetY, ANIMATION_DURATION * 0.3f + random.nextFloat(), Interpolation.pow2Out),
    ...
    protected void onEnter() {
        ...
        btn.addAction(
                Actions.moveTo(targetX,targetY + 120, 0.3f, Interpolation.sineOut)
        );
    }
    ...
    protected void onExit() {
        ...
        btn.addAction(
                Actions.moveTo(targetX, targetY, 0.3f, Interpolation.sineIn)
        );
    }
