 ...
 * A status effect has an identifier, a value used to modify combat calculations, and a
 ...
 * combat). Only a positive duration counts down and eventually expires. Pending confirmation
 * with Team 6 that this interpretation matches their design intent.
 */
public class StatusEffect {
  ...
  private int duration;
     ...
     * @param duration number of turns the effect remains active for; 0 or less means permanent
     *     (does not expire from ticking)
     */
  ...
  public String getType() {
    ...
    /**
     * Returns the number of turns remaining before this effect expires. 0 or less means the
     * effect is permanent and will not expire from ticking.
     *
