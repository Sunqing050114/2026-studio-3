...
/**
 * Minimal, non-moving test entity used purely to validate that EnemyDropTargetComponent's drop zone
 * actually lines up with where you drag a card on screen. No physics, no health display, no
 * movement — just a sprite + the drop target component, so drag-and-drop can be debugged in
 * isolation from the real player entity.
 *
 * <p>Delete this factory once EnemyDropTargetComponent is confirmed working.
 */
